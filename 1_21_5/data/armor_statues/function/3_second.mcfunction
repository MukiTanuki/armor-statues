...
#
execute as @e[type=minecraft:armor_stand, tag=as_invisible, nbt={Invisible:1b}, nbt=!{Invulnerable:1b}, nbt=!{Marker:1b}, nbt=!{equipment:{mainhand:{count:1} }}, nbt=!{equipment:{offhand:{count:1} }}, nbt=!{equipment:{head:{count:1} }}, nbt=!{equipment:{chest:{count:1} }}, nbt=!{equipment:{legs:{count:1} }}, nbt=!{equipment:{feet:{count:1} }}, nbt=!{CustomNameVisible:1b}, tag=!as_locked] run function armor_statues:set_visible
#
